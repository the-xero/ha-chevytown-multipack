...
COMMANDS = {
    "vehicle_start": {"name": "원격 시동 켜기", "cmd": "VEHICLE_START", "icon": "mdi:reload"},
    ...
    "window_open":   {"name": "창문 열기", "cmd": "WINDOW_OPEN", "icon": "mdi:car"},
    "window_close":  {"name": "창문 닫기", "cmd": "WINDOW_CLOSE", "icon": "mdi:car"},
    "trunk_open":    {"name": "트렁크 열기", "cmd": "TRUNK_OPEN", "icon": "mdi:car"},
    "trunk_close":   {"name": "트렁크 닫기", "cmd": "TRUNK_CLOSE", "icon": "mdi:car"},
    "panic":         {"name": "경적", "cmd": "PANIC", "icon": "mdi:bugle"},
