...
COMMANDS = {
    ...
    "vehicle_stop":  {"name": "원격 시동 끄기", "cmd": "VEHICLE_STOP", "icon": "mdi:car-off"},       
    "door_lock":     {"name": "도어 잠금", "cmd": "DOOR_LOCK", "icon": "mdi:car-door-lock"},
    "door_unlock":   {"name": "도어 열기", "cmd": "DOOR_UNLOCK", "icon": "mdi:car-door-lock-open"},
    ...
    "trunk_open":    {"name": "트렁크 열기", "cmd": "TRUNK_OPEN", "icon": "mdi:car-back"},
    "trunk_close":   {"name": "트렁크 닫기", "cmd": "TRUNK_CLOSE", "icon": "mdi:car-back"},
